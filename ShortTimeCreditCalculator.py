...
i1 = 0
#inflation rates are retrieved from: https://www.statista.com/statistics/271077/inflation-rate-in-spain/
#Interest rates are retrieved from: https://tradingeconomics.com/spain/interest-rate
...
if months <= 12:
    ...
    moneypermonth = round((total_financed / months), 2)
    firstyear = round(((moneypermonth * 12) / ((1 + (growth_money[0])) ** 12)), 4)
    secondyear = round(((moneypermonth * 12) / ((1 + (growth_money[1])) ** 12)), 4)
    thirdyear = round(((moneypermonth) * (months - 24)) / ((1 + (growth_money[2])) ** (months - 24)), 2)
